...
<tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
        ...
        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><tr>
                <td height="20" bgcolor="#FFFFFF"><div align="center">
                    <input type="checkbox" name="checkbox3" id="checkbox3" />
                </div></td>
                <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($type["type_id"]); ?></div></td>
                <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($type["type_name"]); ?></div></td>


                <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE21">
<a href="<?php echo U('Attribute/showlist', array('type_id'=>$type['type_id']));?>" style="color: #3f9aff"><img src="<?php echo C('AD_IMG_URL');?>edit.gif" width="10" height="10" />查看列表</a>
