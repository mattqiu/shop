		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo C('SITE_URL'); echo ($picinfo[0]["pics_big"]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo C('SITE_URL'); echo ($picinfo[0]["pics_mid"]); ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="" method="post" class="choose">
						<ul>
							<?php if(is_array($attrinfo)): foreach($attrinfo as $key=>$v): ?><li class="product">
								<dl>
									<dt><?php echo ($v["attr_name"]); ?>：</dt>
									<dd>
							<?php if(is_array($v['attr_values'])): foreach($v['attr_values'] as $k=>$vv): if(($k) == "0"): ?><a class="selected" href="javascript:;"><?php echo ($vv); ?> <input type="radio" name="color" value="黑色" checked="checked" /></a>
									<?php else: ?>
									<a  href="javascript:;"><?php echo ($vv); ?> <input type="radio" name="color" value="黑色"  /></a><?php endif; endforeach; endif; ?>
									</dd>
								</dl>
							</li><?php endforeach; endif; ?>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php if(is_array($attrinfo1)): foreach($attrinfo1 as $key=>$v): ?><li><span><?php echo ($v["attr_name"]); ?>：</span><?php echo ($v["attr_value"]); ?></li><?php endforeach; endif; ?>
							</ul>
						</div>
