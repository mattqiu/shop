		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo C('IMG_URL');?>preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo C('IMG_URL');?>preview_m1.jpg" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo C('IMG_URL');?>preview_m1.jpg',largeimage: '<?php echo C('IMG_URL');?>preview_l1.jpg'}"><img src="<?php echo C('IMG_URL');?>preview_s1.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo C('IMG_URL');?>preview_m2.jpg',largeimage: '<?php echo C('IMG_URL');?>preview_l2.jpg'}"><img src="<?php echo C('IMG_URL');?>preview_s2.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '<?php echo C('IMG_URL');?>preview_m3.jpg',largeimage: '<?php echo C('IMG_URL');?>preview_l3.jpg'}">  
	    							<img src="<?php echo C('IMG_URL');?>preview_s3.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '<?php echo C('IMG_URL');?>preview_m4.jpg',largeimage: '<?php echo C('IMG_URL');?>preview_l4.jpg'}">  
	    							<img src="<?php echo C('IMG_URL');?>preview_s4.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '<?php echo C('IMG_URL');?>preview_m5.jpg',largeimage: '<?php echo C('IMG_URL');?>preview_l5.jpg'}">  
	    							<img src="<?php echo C('IMG_URL');?>preview_s5.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '<?php echo C('IMG_URL');?>preview_m6.jpg',largeimage: '<?php echo C('IMG_URL');?>preview_l6.jpg'}">  
	    							<img src="<?php echo C('IMG_URL');?>preview_s6.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '<?php echo C('IMG_URL');?>preview_m7.jpg',largeimage: '<?php echo C('IMG_URL');?>preview_l7.jpg'}">  
	    							<img src="<?php echo C('IMG_URL');?>preview_s7.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '<?php echo C('IMG_URL');?>preview_m8.jpg',largeimage: '<?php echo C('IMG_URL');?>preview_l8.jpg'}">  
	    							<img src="<?php echo C('IMG_URL');?>preview_s8.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '<?php echo C('IMG_URL');?>preview_m9.jpg',largeimage: '<?php echo C('IMG_URL');?>preview_l9.jpg'}">  
	    							<img src="<?php echo C('IMG_URL');?>preview_s9.jpg"></a>
								</li>
							</ul>
						</div>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<img src="<?php echo C('IMG_URL');?>desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG_URL');?>desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG_URL');?>desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG_URL');?>desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG_URL');?>desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG_URL');?>desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG_URL');?>desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG_URL');?>desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="<?php echo C('IMG_URL');?>desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->
