				...
				<form action="/index.php/Home/User/login.html" method="post">
					<ul>
						...
						<li class="checkcode">
							...
							<img id="yzm" src="<?php echo U('User/yanzhengma');?>" alt="" />
							<span>看不清？<a href="javascript:void(0)" onclick="changeimg()">换一张</a></span>
						</li>
						<script>
							function changeimg() {
								$('#yzm').attr("src", "<?php echo U('User/yanzhengma',array('id'=>rand()));?>");
							}
