			...
			<div class="goodslist mt10">
				<ul>
					<?php if(is_array($info)): foreach($info as $key=>$v): ?><li>
						<dl>
							<dt><a href="<?php echo U('goods',array('goods_id'=>$v['goods_id']));?>"><img src="<?php echo C('SITE_URL'); echo (substr($v["goods_small_logo"],2)); ?>" alt="" /></a></dt>
							<dd><a href="<?php echo U('goods',array('goods_id'=>$v['goods_id']));?>"><?php echo ($v["goods_name"]); ?></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMG_URL');?>goods2.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMG_URL');?>goods3.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMG_URL');?>goods4.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMG_URL');?>goods5.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMG_URL');?>goods6.jpg" alt="" /></a></dt>
